...
import { aboutCta } from "@/lib/content/about";
      ...
      <Reveal>
        ...
        >
          ...
          <div className="relative">
            <Tagline className="mx-auto">{aboutCta.tagline}</Tagline>
            ...
            <Link
              ...
              className={cn(
                ...
                "h-auto w-full py-[1.1rem] text-base font-semibold lg:w-auto lg:px-[2.75rem]"
              )}
            >
              {aboutCta.primaryCta.text}
            </Link>
          </div>
        </GlassCard>
      </Reveal>
