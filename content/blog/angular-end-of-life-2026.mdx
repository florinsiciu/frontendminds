...
Every major Angular release follows the same lifecycle: 6 months of active support with regular updates and patches, followed by 12 months of Long-Term Support with critical fixes and security patches only. After 18 months total, the version reaches end-of-life. For a broader overview of how this lifecycle works across all software, see [What Software End of Life Actually Means](/blog/software-end-of-life-guide).
